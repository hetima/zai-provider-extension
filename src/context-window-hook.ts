/**
 * Portions of this file are adapted from Unify Chat Provider
 * https://github.com/smallmain/vscode-unify-chat-provider
 * Copyright (c) 2025 SmallMain
...
const CONFIG_NAMESPACE = "zai";
const DEFAULT_FIX001_CONTEXT_INDICATOR_DISPLAY = true;
const FIX001_CONTEXT_INDICATOR_DISPLAY_CONFIG_KEY =
  "fixes.fix001ContextIndicatorDisplay";
export type ProviderUsage = CompletionUsage | ResponseUsage;
